...
- Sub2API administrator keys are write-only, remote management targets require explicit opt-in plus HTTPS, redirects are refused, and errors do not expose credentials.
