...
<section class="orbit-landing-hero orbit-landing-hero--compact">
  <div class="orbit-landing-copy">
    ...
    <h1>本地运行，<br>一处掌控。</h1>
    <p class="orbit-landing-tagline">把订阅归档、价格信号、额度健康和 CPA 运行状态放进同一个本地工作台。</p>
...
<div class="orbit-feature-grid">
  <a href="./modules/#订阅资产"><span>01 / ARCHIVE</span><strong>订阅资产</strong><p>可追溯的 JSON 归档，为 CPA 运行目录生成可重建投影。</p></a>
